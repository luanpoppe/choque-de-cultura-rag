/** Hero do estado vazio — interação na story 3.2/3.4. */
  ...
  return (
    <section className="px-7 pb-7 pt-2 text-center">
      ...
      <button
        type="button"
        disabled
        className="mb-3 flex w-full cursor-not-allowed items-center justify-center gap-2.5 rounded-full bg-gradient-to-br from-choque-accent-secondary to-choque-accent px-5 py-3.5 text-sm font-semibold text-white opacity-90 shadow-[0_8px_24px_rgba(225,29,72,0.25)]"
        aria-disabled="true"
      >
